...
import com.kennedy.cursomc.dto.ClienteDTO;
import com.kennedy.cursomc.dto.ClienteNewDTO;
...
public class ClienteService {
	...
	public void delete (Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não possível excluir clientes que possui pedidos");
		}
	}
	...
	public Cliente fingByEmail(String email){
	...
	public URI updaloadProfilePicture(MultipartFile multipartFile) {
